...
{\bf Lucky Sort Inc., Cofounder} - Portland, OR; April 2011 \\
Currently addressing the design and implementation needs of a tech startup
for both product and client work.
...
Python, Scala, R, Java, SQL, Javascript, LaTeX, Emacs, Linux (primarily
Debian-based), git, ggplot, Postgresql, Mongodb, Redis, Rabbitmq,
distributed design, agile, information science, data visualization
